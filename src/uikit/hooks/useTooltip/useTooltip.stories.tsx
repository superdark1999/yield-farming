...
export const EventPropagationAndMobile: React.FC = () => {
  ...
  const {
    ...
    targetRef: targetRefClick,
    tooltip: tooltipClick,
  } = useTooltip('You clicked on the help icon but the card did not expand', 'right', 'click')
  const {
    tooltipVisible: tooltipVisibleHover,
    targetRef: targetRefHover,
    tooltip: tooltipHover,
  } = useTooltip('You hovered over the help icon', 'right', 'hover')
  return (
    <div
      style={{
        display: 'flex',
...
export const FineTuning: React.FC = () => {
  ...
  } = useTooltip('Just default tooltip', 'top-start', 'hover')
  const {
...
export const ScreenEdges: React.FC = () => {
  ...
  } = useTooltip('I should not touch the edge of the screen', 'top', 'click')
  const {
